...
var Pe2 = "button";
function Ee(e8, t11) {
  let l14 = (0, import_react50.useId)(), { id: p6 = `headlessui-disclosure-button-${l14}`, disabled: i15 = false, autoFocus: c15 = false, ...n13 } = e8, [o17, r18] = M8("Disclosure.Button"), m10 = fe3(), s13 = m10 === null ? false : m10 === o17.panelId, E12 = (0, import_react94.useRef)(null), f22 = y(E12, t11, o4((u17) => {
...
var ge2 = O.RenderStrategy | O.Static;
function Ae4(e8, t11) {
  let l14 = (0, import_react50.useId)(), { id: p6 = `headlessui-disclosure-panel-${l14}`, transition: i15 = false, ...c15 } = e8, [n13, o17] = M8("Disclosure.Panel"), { close: r18 } = J4("Disclosure.Panel"), [m10, s13] = (0, import_react94.useState)(null), E12 = y(t11, o4((b9) => {
...
function Ft2(e8, i15) {
  var $3, q4;
  let o17 = (0, import_react50.useId)(), { id: r18 = `headlessui-listbox-options-${o17}`, anchor: a20, portal: m10 = false, modal: x10 = true, transition: d13 = false, ...p6 } = e8, n13 = xe(a20), [u17, P7] = (0, import_react102.useState)(null);
  n13 && (m10 = true);
...
function ut(e8, n13) {
  let r18 = (0, import_react50.useId)(), { id: l14 = `headlessui-menu-item-${r18}`, disabled: o17 = false, ...u17 } = e8, [p6, s13] = w9("Menu.Item"), m10 = p6.activeItemIndex !== null ? p6.items[p6.activeItemIndex].id === l14 : false, a20 = (0, import_react103.useRef)(null), t11 = y(n13, a20);
  n(() => {
...
function ft2(o17, a20) {
  let f22 = (0, import_react50.useId)(), { id: C9 = `headlessui-popover-button-${f22}`, disabled: T10 = false, autoFocus: S7 = false, ...p6 } = o17, [l14, c15] = se3("Popover.Button"), { isPortalled: d13 } = be4("Popover.Button"), r18 = (0, import_react104.useRef)(null), s13 = `headlessui-focus-sentinel-${(0, import_react50.useId)()}`, R9 = Me3(), m10 = R9 == null ? void 0 : R9.closeOthers, P7 = st2() !== null;
...
function Oe2(o17, a20) {
  let f22 = (0, import_react50.useId)(), { id: C9 = `headlessui-popover-backdrop-${f22}`, transition: T10 = false, ...S7 } = o17, [{ popoverState: p6 }, l14] = se3("Popover.Backdrop"), [c15, d13] = (0, import_react104.useState)(null), r18 = y(a20, d13), s13 = u13(), [R9, m10] = x3(T10, c15, s13 !== null ? (s13 & i11.Open) === i11.Open : p6 === 0), h7 = o4((g6) => {
...
function yt3(o17, a20) {
  let f22 = (0, import_react50.useId)(), { id: C9 = `headlessui-popover-panel-${f22}`, focus: T10 = false, anchor: S7, portal: p6 = false, modal: l14 = false, transition: c15 = false, ...d13 } = o17, [r18, s13] = se3("Popover.Panel"), { close: R9, isPortalled: m10 } = be4("Popover.Panel"), h7 = `headlessui-focus-sentinel-before-${f22}`, P7 = `headlessui-focus-sentinel-after-${f22}`, n13 = (0, import_react104.useRef)(null), v4 = xe(S7), [g6, _8] = Re(v4), L6 = be();
  v4 && (p6 = true);
...
function xe3(n13, o17) {
  var L6;
  let s13 = (0, import_react50.useId)(), h7 = u5(), b9 = a3(), { id: T10 = h7 || `headlessui-switch-${s13}`, disabled: t11 = b9 || false, checked: p6, defaultChecked: y9, onChange: S7, name: c15, value: u17, form: d13, autoFocus: m10 = false, ...F6 } = n13, _8 = (0, import_react107.useContext)(E10), [H13, k5] = (0, import_react107.useState)(null), M9 = (0, import_react107.useRef)(null), U8 = y(M9, o17, _8 === null ? null : _8.setSwitch, k5), l14 = l2(y9), [a20, r18] = T(p6, S7, l14 != null ? l14 : false), I6 = p(), [P7, D6] = (0, import_react107.useState)(false), g6 = o4(() => {
...
function Ge4(e8, r18) {
  var ee7, te6;
  let t11 = (0, import_react50.useId)(), { id: l14 = `headlessui-tabs-tab-${t11}`, disabled: a20 = false, autoFocus: n13 = false, ...s13 } = e8, { orientation: g6, activation: b9, selectedIndex: f22, tabs: d13, panels: u17 } = C8("Tab"), T10 = Y3("Tab"), p6 = C8("Tab"), [c15, h7] = (0, import_react109.useState)(null), m10 = (0, import_react109.useRef)(null), M9 = y(m10, r18, h7);
...
function Ne4(e8, r18) {
  var A7, E12, _8, D6;
  let t11 = (0, import_react50.useId)(), { id: l14 = `headlessui-tabs-panel-${t11}`, tabIndex: a20 = 0, ...n13 } = e8, { selectedIndex: s13, tabs: g6, panels: b9 } = C8("Tab.Panel"), f22 = Y3("Tab.Panel"), d13 = (0, import_react109.useRef)(null), u17 = y(d13, r18);
